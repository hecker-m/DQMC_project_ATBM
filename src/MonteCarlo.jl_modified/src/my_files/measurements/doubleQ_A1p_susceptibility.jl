...
"""
Calculates the XX-kernel of the A1` double-Q` susceptibility  
"""
@inline Base.@propagate_inbounds function A1_Q1Q2_X_kernel(mc::DQMC, model::TwoBandModel, klkPlP::NTuple{4}, 
    G::Union{GreensMatrix, _GM4{T}}, flv) where {T <: Matrix}
    return A1_Q1Q2_X_kernel(mc, model, klkPlP, G, flv, field(mc))
end
@inline Base.@propagate_inbounds function A1_Q1Q2_X_kernel(mc::DQMC, model::TwoBandModel, klkPlP::NTuple{4}, 
    G::GreensMatrix, flv, field::AbstractMagnBosonField)
    return A1_Q1Q2_X_kernel(mc, model, klkPlP, (G, G, G, G), flv, field)
end


@inline Base.@propagate_inbounds function A1_Q1Q2_X_kernel( mc, model::TwoBandModel, klkPlP::NTuple{4}, 
