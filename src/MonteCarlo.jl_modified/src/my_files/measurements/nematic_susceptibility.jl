...
# function _iterate(::EachDoubleSitePairByDistance, l::Lattice, state = (0, 1, 1, 1))
...
# end
# _length(::EachDoubleSitePairByDistance, l::Lattice) = length(l)^2
# _eltype(::EachDoubleSitePairByDistance, l::Lattice) = NTuple{3, Int}
